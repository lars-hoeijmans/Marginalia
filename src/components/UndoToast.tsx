...
export default function UndoToast({
  ...
  return (
    <motion.div
      ...
      className="absolute bottom-6 left-1/2 -translate-x-1/2 z-50 flex items-center gap-3 bg-surface border border-edge px-5 py-3 rounded-xl shadow-sm overflow-hidden min-w-[260px]"
    >
