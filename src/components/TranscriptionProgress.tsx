...
export default function TranscriptionProgress() {
  return (
    <motion.div
      ...
      className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 flex items-center gap-3 bg-surface border border-edge px-5 py-3 rounded-xl shadow-sm min-w-[260px]"
    >
      <motion.div
        animate={{ rotate: 360 }}
